...
const Login = () => {
    ...
    const handlePlanEmergenciaClick = ()=>{
        //Redirige al usuario al plan de emergencia 
       navigate('/plan');
    };
        ...
        >
            {!loggedIn ? (
                <div className="card p-4">
                    ...
                    <p className="Plan Emergencia">
                        Información sobre el plan de emergencia<br/>&nbsp;
                        <button
                            type="button"
                            className="btn btn-link"
                            onClick={handlePlanEmergenciaClick}
                        >
                            Informacion Plan Emergencia
                        </button>
                    </p>
                </div>
            ) : (
